                            ...
                            lobbyData.map((lobby) => (
                                <div key={lobby.Group_ID}>
                                    <div className="flex bg-lightgreen border-b-2">
                                        ...
                                        <div className={`flex-grow pl-3 ${lobby.Members === 4 ? 'py-3' : 'py-2'} flex justify-between items-center text-white`}>
                                            <span>{lobby.Group_ID}</span>

                                            {lobby.Members !== 4 && (
                                                <button
                                                    onClick={() => join_group(lobby.Group_ID)}
                                                    className={"flex-shrink-0 mr-5 py-1 px-3 border border-black rounded-full  text-black font-semibold bg-yellow hover:bg-hoveryellow"}
                                                >
                                                    Join
                                                </button>
                                            )}
