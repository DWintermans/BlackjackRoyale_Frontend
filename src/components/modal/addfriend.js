            ...
            <div className="bg-lightgreen border border-offwhite rounded-2xl p-2.5 w-full text-white">
                ...
                <div className="mt-4">
                    ...
                    {searchResult && searchResult.map((result, index) => (
                        <div key={index} className="text-white mb-2 flex justify-between items-center">
                            <span>{result.user_name}</span>

                            {result.isFriendRequested ? (
                                <div
                                    className="font-semibold mx-1 py-1 px-2.5 border text-black border-black rounded-full bg-hoveryellow"
                                >
                                    SEND
                                </div>
                            ) : (
